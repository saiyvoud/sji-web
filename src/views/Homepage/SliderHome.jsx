...
export default function SliderHome() {
  ...
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div className="flex h-[450px] w-[380px] flex-col items-center justify-center rounded-md bg-[#003049] px-7 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] lg:h-[470px] 2xl:w-[360px]">
            <h3
              className={`mb-10 mt-7 ${i18n.language === "en" ? "mt-0" : ""} text-[24px] font-semibold text-white lg:mb-5 lg:h-[70px]`}
            >
