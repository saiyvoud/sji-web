  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content={`${data?.data?.company?.name}Analysis, ການບໍລິການ, SJI,Investment,ສອນເຈົ້າລົງທຶນ, ລົງທຶນ,สอนลงทุน, การลงทุน`} />
        <meta name="robots" content="index, follow" />
        ...
        <meta property="og:url" content={"https://sji.homefind.la/analysis/country/" + company} />
      </Helmet>
      <Navbar>
        {isLoading ? (
          ...
          <div className="relative z-0 w-full before:absolute before:-z-[1] before:h-[350px] before:w-full before:bg-[#003049] sm:before:h-[300px] md:before:h-[320px]">
            ...
            alt=""
            src={bgOverlay2}
            className="absolute hidden h-[350px] w-full bg-cover bg-bottom sm:block sm:h-[300px] sm:opacity-50 md:h-[320px]"
          /> */}
